...
const Navbar = () => {
	...
	const ANIMATION_DELAY = windowWidth === 0 || windowWidth <= md ? 0 : 0.8;
		...
		>
			<h1 className="relative text-2xl capitalize font-signature text-accent group top-1">
				<Link href="/#hero" className="block">
					{author.name}
					<div className="absolute bottom-1.5 left-0 h-[1px] w-0 group-hover:w-full bg-accent duration-300" />
				</Link>
			</h1>
			...
			{(navbarCollapsed || (windowWidth > 0 && windowWidth > md)) && (
